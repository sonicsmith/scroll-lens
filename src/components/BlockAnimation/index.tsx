          ...
          <g id="d-appswrapper">
            <g id="d-app">
              ...
              <g>
                <linearGradient
                  ...
                  gradientTransform="matrix(1 0 0 -1 0 1900)"
                >
                  <stop offset={0} style={{ stopColor: "#EBC18D" }} />
                  <stop offset="0.2302" style={{ stopColor: "#EBC18D" }} />
                  <stop offset="0.4367" style={{ stopColor: "#EBC18D" }} />
                  <stop offset="0.634" style={{ stopColor: "#EBC18D" }} />
                  <stop offset="0.8245" style={{ stopColor: "#EBC18D" }} />
                  <stop offset={1} style={{ stopColor: "#EBC18D" }} />
                </linearGradient>
                <path
                  fill="url(#SVGID_9_)"
            ...
            <g>
              ...
              <g>
                ...
                <circle fill="#b58c5b" cx="581.8" cy="310.5" r="0.7" />
                ...
                <circle fill="#b58c5b" cx="604.2" cy="357.9" r="1.4" />
                <circle fill="#FFFFFF" cx="521.8" cy={341} r="0.7" />
                <circle fill="#b58c5b" cx="506.9" cy={322} r="0.7" />
                <circle fill="#b58c5b" cx={513} cy="361.5" r="0.7" />
                <circle fill="#b58c5b" cx="554.8" cy="313.4" r={1} />
                <circle fill="#b58c5b" cx="539.3" cy="341.7" r="1.4" />
          ...
          <g id="d-apps2wrapper">
            ...
            <g>
              ...
              <g>
                ...
                <circle fill="#b58c5b" cx="1277.5" cy="771.4" r="0.7" />
                ...
                <circle fill="#b58c5b" cx={1300} cy="818.8" r="1.4" />
                <circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7" />
                <circle fill="#b58c5b" cx="1202.6" cy="782.9" r="0.7" />
                <circle fill="#b58c5b" cx="1208.8" cy="822.4" r="0.7" />
                <circle fill="#b58c5b" cx="1250.5" cy="774.3" r={1} />
                <circle fill="#b58c5b" cx="1235.1" cy="802.6" r="1.4" />
...
RK5CYII="
		...
		555.6,608.9 		"
            ...
            >
              ...
              <stop
                offset="0.2113"
                style={{ stopColor: "#FEEEDA", stopOpacity: "0.2113" }}
              />
              <stop
                offset="0.4448"
                style={{ stopColor: "#FEEEDA", stopOpacity: "0.4448" }}
              />
              <stop
                offset="0.6617"
                style={{ stopColor: "#FEEEDA", stopOpacity: "0.6617" }}
              />
              <stop
                offset="0.8535"
                style={{ stopColor: "#FEEEDA", stopOpacity: "0.8535" }}
              />
              <stop offset={1} style={{ stopColor: "#FEEEDA" }} />
            </linearGradient>
            <polygon
              className="particlespoly"
              fill="url(#SVGID_42_)"
          ...
          <g id="redblocksparticles">
			...
			1141.3,409 			"
              ...
              <g>
                ...
                <circle cx="1143.5" cy="454.4" r="0.7" fill="#b58c5b" />
                ...
                <circle cx={1166} cy="501.8" r="1.4" fill="#b58c5b" />
                <circle cx="1083.5" cy="484.9" r="0.7" fill="#FFFFFF" />
                <circle cx="1068.6" cy="465.9" r="0.7" fill="#b58c5b" />
                <circle cx="1074.8" cy="505.4" r="0.7" fill="#b58c5b" />
                <circle cx="1116.5" cy="457.3" r={1} fill="#b58c5b" />
                <circle cx="1101.1" cy="485.6" r="1.4" fill="#b58c5b" />
            ...
            <g>
              ...
              <g>
                ...
                <circle cx="827.5" cy="642.4" r="0.7" fill="#b58c5b" />
                ...
                <circle cx={850} cy="689.8" r="1.4" fill="#b58c5b" />
                <circle cx="767.5" cy="672.9" r="0.7" fill="#FFFFFF" />
                <circle cx="752.6" cy="653.9" r="0.7" fill="#b58c5b" />
                <circle cx="758.8" cy="693.4" r="0.7" fill="#b58c5b" />
                <circle cx="800.5" cy="645.3" r={1} fill="#b58c5b" />
                <circle cx="785.1" cy="673.6" r="1.4" fill="#b58c5b" />
            ...
            <g>
              ...
              <g>
                ...
                <circle cx="668.5" cy="735.4" r="0.7" fill="#b58c5b" />
                ...
                <circle cx={691} cy="782.8" r="1.4" fill="#b58c5b" />
                <circle cx="608.5" cy="765.9" r="0.7" fill="#FFFFFF" />
                <circle cx="593.6" cy="746.9" r="0.7" fill="#b58c5b" />
                <circle cx="599.8" cy="786.4" r="0.7" fill="#b58c5b" />
                <circle cx="641.5" cy="738.3" r={1} fill="#b58c5b" />
                <circle cx="626.1" cy="766.6" r="1.4" fill="#b58c5b" />
            ...
            <g>
              ...
              <g>
                ...
                <circle cx="513.5" cy="828.4" r="0.7" fill="#b58c5b" />
                ...
                <circle cx={536} cy="875.8" r="1.4" fill="#b58c5b" />
                <circle cx="453.5" cy="858.9" r="0.7" fill="#FFFFFF" />
                <circle cx="438.6" cy="839.9" r="0.7" fill="#b58c5b" />
                <circle cx="444.8" cy="879.4" r="0.7" fill="#b58c5b" />
                <circle cx="486.5" cy="831.3" r={1} fill="#b58c5b" />
                <circle cx="471.1" cy="859.6" r="1.4" fill="#b58c5b" />
		...
		l-0.8-1.3L1524.4,178.1z"
          ...
          <g id="firstBlock">
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#FEEEDA" }} />
              <stop offset="0.2857" style={{ stopColor: "#ebd4b9" }} />
              <stop offset="0.75" style={{ stopColor: "#f0cb9e" }} />
              <stop offset={1} style={{ stopColor: "#EBC18D" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_49_)"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#a18460" }} />
              <stop offset="0.1701" style={{ stopColor: "#a18460" }} />
              <stop offset="0.4158" style={{ stopColor: "#a18460" }} />
              <stop offset="0.6441" style={{ stopColor: "#a18460" }} />
              <stop offset="0.8458" style={{ stopColor: "#a18460" }} />
              <stop offset={1} style={{ stopColor: "#a18460" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_50_)"
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop offset={0} style={{ stopColor: "#b58c5b" }} />
              <stop offset="5.850000e-02" style={{ stopColor: "#b58c5b" }} />
              <stop offset="0.6415" style={{ stopColor: "#b58c5b" }} />
              <stop offset={1} style={{ stopColor: "#a18460" }} />
            </linearGradient>
            <polygon
              fill="url(#SVGID_51_)"
